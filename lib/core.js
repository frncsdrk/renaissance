...
// Who would want to unregister a component while runtime?!?
...
potion.defineComponent = function(Component) {
    // Component.prototype.attachTo = function() {
        // console.log('can extend prototype!!!');
    // };
    Component.prototype = potion.Component.prototype;
...
potion.Component.prototype.setNodes = function(nodes) {
    this.nodes = nodes;
}
...
potion.Component.prototype.attachTo = function(selector) {
    ...
    potion.registerComponent(this, nodes);
};
// potion.Component.prototype.unattachFrom = function(node) {
