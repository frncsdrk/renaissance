...
define(
    ...
    , function() {
        ...
        potion.Component.prototype.expose = function(evNamespace, componentEv, cb) {
            // TODO: make namespace optional, which will not be recommended -> document event pollution
            document.addEventListener(evNamespace + '.' + componentEv, cb);
        };
        // trigger exposed events
        potion.Component.prototype.trigger = function(evName) {
